...
public class DocumentBuilder {
	...
	public  static NewsDoc defaultNewsDocBuild(String url, String htmlSources) {
		...
		publishTime = publishTime.matches(HtmlRegexConsts.PUBLISH_DATE_TIME_MATCHE)
				? publishTime :  doc.body().text().replaceFirst(HtmlRegexConsts.PUBLISH_DATE_TIME_MATCHE, "$1");
