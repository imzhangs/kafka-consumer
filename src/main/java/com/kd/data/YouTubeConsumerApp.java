...
public class YouTubeConsumerApp {
	...
	public static void main(String[] args) throws Exception {
		final ApplicationContext applicationContext = SpringApplication.run(YouTubeConsumerApp.class, args);
		NativeConsumer consumer=applicationContext.getBean(NativeConsumer.class);
		consumer.init();
		Thread.sleep(5000);
		consumer.topic="youtube-account";
		consumer.consume();
	}
}
